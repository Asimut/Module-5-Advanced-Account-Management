...
function setLMSData(objid, response, prompt){   
  ...
  if(courseVersionForLMS){
    ...
    // windowObj.SCORM_objAPI.LMSSetValue('cmi.interactions', objid);
    // // windowObj.SCORM_CallLMSSetValue('cmi.interactions.'+objid+'.id', id);
    // windowObj.SCORM_objAPI.LMSSetValue('cmi.interactions.'+objid+'.id', id);
    // windowObj.SCORM_objAPI.LMSSetValue('cmi.interactions.'+objid+'.type', 'fill-in');
    // windowObj.SCORM_objAPI.LMSSetValue('cmi.interactions.'+objid+'.timestamp', dtmTime);
    // windowObj.SCORM_objAPI.LMSSetValue('cmi.interactions.'+objid+'.learner_response', strResponse);
    // windowObj.SCORM_objAPI.LMSSetValue('cmi.interactions.'+objid+'.result', blnCorrect);
    // windowObj.SCORM_objAPI.LMSSetValue('cmi.interactions.'+objid+'.latency', latency);
    // windowObj.SCORM_objAPI.LMSSetValue('cmi.interactions.'+objid+'.description', strDescription); 
  ...
  $('.page').each(function(){
    ...
    if(getBlockQty>0){
      ...
      console.log(conrinueBtn)
        ...
        conrinueBtn.prop('disabled', true);
        conrinueBtn.addClass('disabled');
      ...
      if(valid){
        conrinueBtn.prop('disabled', false);
        conrinueBtn.removeClass('disabled');
      } else {
        conrinueBtn.prop('disabled', true);
        conrinueBtn.addClass('disabled');
      }
